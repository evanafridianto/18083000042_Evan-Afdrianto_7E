...
function input_text($a, $b, $c = '', $d = '')
{
    if(!is_array($c)){
        ...
        return '<input type="text" placeholder="Masukan '.$a.'"  name="' . $a . '" value="' . $b . '" class="form-control' . $c . '"' . $d . '>' . "\n";
    }
    else{
        $set='';
...
function textarea($a, $b, $c = '', $d = '')
{
    if(!is_array($c)){
        ...
        return '<textarea name="' . $a . '" placeholder="Masukan '.$a.'" class="form-control' . $c . '"' . $d . '>' . $b . '</textarea>' . "\n";
    }
    else{
        $set='';
        foreach ($c as $key => $value) {
...
function select($a, $b = array(), $c = array(), $d = '', $e = '')
{
    if(!is_array($d)){
        ...
        return '<select name="' . $a . '" class="custom-select' . $d . '"' . $e . '>' . "\n" . $data . "\t\t\t\t\t" . '</select>' . "\n\t\t\t\t";
    }
    else{
        $set='';
